...
| `sourceSetName`           | `String`                                        | `main`                                              | Specify the name of the [Gradle SourceSet](https://docs.gradle.org/current/dsl/org.gradle.api.tasks.SourceSet.html) to use.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `mainClass`                   | `String`              | *Required*          | The main class to launch your application from. The value can also be initialized [lazily](https://docs.gradle.org/current/userguide/lazy_configuration.html) with a provider.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
